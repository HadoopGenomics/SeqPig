...
flatset = FOREACH RefPos GENERATE flatten($0), mapqual*mapqual;
grouped = GROUP flatset BY ($0, $1, $2) PARALLEL 1;
describe grouped;
base_counts = FOREACH grouped GENERATE group.chr, group.pos, group.base, COUNT(flatset), SUM(flatset);
