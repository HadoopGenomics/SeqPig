...
then
	...
	$JAVA_HOME/bin/java -classpath ${SEQPIG_LIBJARS}:${CLASSPATH} -Dhadoopbam.samheaderreader.validation-stringency=STRICT fi.aalto.seqpig.io.SAMFileHeaderReader $1
